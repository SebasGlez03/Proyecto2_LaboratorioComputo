...
public class ComputadoraEntidad implements Serializable {
    ...
    /**
     * Constructor para inicializar una entidad Computadora con los valores proporcionados.
     *
     * @param centroComputoEntidad La entidad que representa el centro de cómputo al que pertenece la computadora.
     * @param estudiante           La entidad que representa al estudiante asignado a la computadora.
     * @param ip                   La dirección IP de la computadora.
     * @param estatusoInscripcion   El estado o inscripción de la computadora (ej. ocupada, disponible, etc.).
     * @param numMaquina           El número de máquina de la computadora dentro del Centro de cómputo.
     */
    public ComputadoraEntidad(CentroComputoEntidad centroComputoEntidad, EstudianteEntidad estudiante, String ip, String estatusoInscripcion, int numMaquina, List<String> software) {

        this.centroComputoEntidad = centroComputoEntidad;
        this.estudiante = estudiante;
        this.ip = ip;
        this.software = software;
        this.estatusInscripcion = estatusoInscripcion;
    ...
    public String toString() {
        return "computadoraEntidad{" + "idComputadora=" + idComputadora + ", centroComputoEntidad=" + centroComputoEntidad + ", estudiante=" + estudiante + ", ip=" + ip + ", estatusoInscripcion=" + estatusInscripcion + ", software=" + software + ", numMaquina=" + numMaquina + '}';
    }
