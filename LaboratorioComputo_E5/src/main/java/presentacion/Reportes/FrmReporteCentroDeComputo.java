 ...
 * @author nomar
 */
public class FrmReporteCentroDeComputo extends javax.swing.JFrame {

    /**
     * Creates new form FrmReporteCentroDeComputo
     */
    public FrmReporteCentroDeComputo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        centroDeComputo.setText("Centro de Computo");
        getContentPane().add(centroDeComputo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 90, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReporteCentroDeComputo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
